...
export default function UnlockMoreBenefits() {
    return (
        <div className="flex flex-col py-12 px-6 gap-2 items-center justify-center bg-[#1E1E1E] border border-[#333333] p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out">
