  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between">
        <div className="pb-4">
          <SectionText
            ...
            subtitle="Gerencie suas categorias, crie novas ou edite."
          />
        </div>
        <div className="group">
          <Cog
            ...
            categories.map((category, index) => (
              <TableRow key={index}>
                ...
                <TableCell className="text-zinc-500">
                  <div
                    className="rounded-full h-2 w-6"
                  ...
                  <div className="-mx-3 -my-1.5 sm:-mx-2.5">
                    <Dropdown>
                      ...
                      <DropdownMenu anchor="bottom end">
                        ...
                        <DropdownItem onClick={() => handleCategory(category)}>
                          Deletar
                        </DropdownItem>
                      </DropdownMenu>
                    </Dropdown>
      ...
      <Alert
        ...
        onClose={() => setIsOpenModalAddCard(false)}
      >
        <AlertDescription>
          <Field>
        ...
        <AlertActions>
          <Button onClick={() => setIsOpenModalAddCard(false)}>Cancelar</Button>
