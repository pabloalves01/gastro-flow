...
import {
  ...
  XMarkIcon, // Ícone de fechar menu
...
function Sidenav() {
  ...
  return (
    <>
      ...
      {/* Sidebar responsiva */}
      <div className={`fixed inset-y-0 left-0 z-40 w-64 transform bg-[#1E1E1E] border-r border-[#333333] transition-transform duration-300 ease-in-out lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <Sidebar>
          <SidebarHeader>
            <Dropdown>
